...
app.post('_api/run-migration',async c => {
  try {
    const { handle } = await import("./endpoints/run-migration_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/device-tokens/register',async c => {
  try {
    const { handle } = await import("./endpoints/device-tokens/register_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.post('_api/device-tokens/unregister',async c => {
  try {
    const { handle } = await import("./endpoints/device-tokens/unregister_POST.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
...
app.get('_api/favorites',async c => {
  try {
    const { handle } = await import("./endpoints/favorites_GET.js");
    let request = c.req.raw;
    const response = await handle(request);
    if (!(response instanceof Response) && response.constructor.name !== "Response") {
      return c.text("Invalid response format. handle should always return a Response object." + response.constructor.name, 500);
