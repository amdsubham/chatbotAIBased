...
import Page_3 from "./pages/chat-embed.tsx";
import PageLayout_3 from "./pages/chat-embed.pageLayout.tsx";
import Page_4 from "./pages/register.tsx";
import PageLayout_4 from "./pages/register.pageLayout.tsx";
...
const fileNameToRoute = new Map([["./pages/admin.tsx","/admin"],["./pages/login.tsx","/login"],["./pages/_index.tsx","/"],["./pages/chat-embed.tsx","/chat-embed"],["./pages/register.tsx","/register"]]);
const fileNameToComponent = new Map([
    ["./pages/admin.tsx", Page_0],
["./pages/login.tsx", Page_1],
["./pages/_index.tsx", Page_2],
["./pages/chat-embed.tsx", Page_3],
["./pages/register.tsx", Page_4],
  ]);
...
"./pages/chat-embed.tsx": PageLayout_3,
"./pages/register.tsx": PageLayout_4,
